...
var voice = new Array()
voice[0] = " 西安是国务院公布的首批国家历史文化名城，历史上先后有十多个王朝在此建都，是世界四大古都之一，是中国历史上建都朝代最多、时间最长、影响力最大的都城之一。早在100万年前，蓝田古人类就在这里建造了聚落；7000年前仰韶文化时期，这里已经出现了城垣的雏形；2008年，西安高陵杨官寨出土距今6000余年的新石器时代晚期城市遗迹，被选为当年中国考古发现之首，这是中国发现的迄今最早的城市遗址，也将西安地区城市历史推进到6000多年前的新石器时代晚期。远古时代，“蓝田猿人”就在这里繁衍生息；新石器“半坡先民”在此建立部落，半坡人的经济生活中，农业生产占有很重要的地位，他们焚毁树木，开垦农田，种植粟等旱地作物。当时人们从事生产活动所使用的工具是石头、兽骨、鹿角和陶片等制造的。除粮食生产外，半坡人也已开始种植蔬菜。家畜饲养业在当时已出现了。"
voice[1] = "声纹识别，生物识别技术的一种，也称为说话人识别，包括说话人辨认和说话人确认。声纹识别就是把声信号转换成电信号，再用计算机进行识别。不同的任务和应用会使用不同的声纹识别技术，如缩小刑侦范围时可能需要辨认技术，而银行交易时则需要确认技术。所谓声纹(Voiceprint)，是用电声学仪器显示的携带言语信息的声波频谱,声纹识别的应用有一些缺点，比如同一个人的声音具有易变性，易受身体状况、年龄、情绪等的影响；比如不同的麦克风和信道对识别性能有影响；比如环境噪音对识别有干扰；又比如混合说话人的情形下人的声纹特征不易提取,如果技术达到一定的水平，可以把文本相关识别并入文本无关识别，把闭集辨认并入开集辨认，从而提供更为方便的使用方法。"
voice[2] = "人工智能是计算机学科的一个分支，二十世纪七十年代以来被称为世界三大尖端技术之一（空间技术、能源技术、人工智能）。也被认为是二十一世纪三大尖端技术（基因工程、纳米科学、人工智能）之一。这是因为近三十年来它获得了迅速的发展，在很多学科领域都获得了广泛应用，并取得了丰硕的成果，人工智能已逐步成为一个独立的分支，无论在理论和实践上都已自成一个系统。人工智能是研究使计算机来模拟人的某些思维过程和智能行为（如学习、推理、思考、规划等）的学科，主要包括计算机实现智能的原理、制造类似于人脑智能的计算机，使计算机能实现更高层次的应用。人工智能将涉及到计算机科学、心理学、哲学和语言学等学科。可以说几乎是自然科学和社会科学的所有学科，其范围已远远超出了计算机科学的范畴，人工智能与思维科学的关系是实践和理论的关系，人工智能是处于思维科学的技术应用层次，是它的一个应用分支。"
...
export class VoiceGather extends React.Component<any,any>{
...
inputChange(e){
    ...
    render(): React.ReactElement<any, string | React.JSXElementConstructor<any>> | string | number | {} | React.ReactNodeArray | React.ReactPortal | boolean | null | undefined {
        return <div>
            <div className="bg bg-blur"> </div>
                ...
                {/* <Card style={{height:"25%",width:"60%",display:"block",margin:"0px auto"}}> */}
                    <p style={{fontSize:"13px",color:"black",width:"80%",lineHeight:"15px",margin:"0px auto"}}>
                   {voice[i]}
                   {/* {voice} */}
                    </p>
                    {/* </Card> */}
                    <Card style={{height:"50px",width:"100px",display:"block",margin:"2% auto"}}>
                    <p style={{fontSize:"20px",lineHeight:"10px"}}>{this.state.min}:{this.state.sec}</p>
                    </Card>
                    <audio controls autoPlay style={{top:"100px",display:"block",margin:"2% auto",backgroundColor:"rgb(8,46,84)"}}></audio>
                        <Button 
                        type="primary" 
                        shape="round" 
                        ...
                        size={'large'} 
                        icon="poweroff" 
                        style={{backgroundColor:"rgb(8,46,84)",display:"block",margin:"2% auto"}}>
                            结束录音
                        </Button>
                        <Input 
                        size="large" 
                        ...
                        style={{width:"200px",display:"block",margin:"0px auto"}}/>
                        <Button 
                        type="primary" 
                        shape="round" 
    ...
    // "postbuild": "move build\\index.html ..\\app\\templates\\ &  move build ..\\app\\static\\" del ..\\app\\templates\\index.html &
